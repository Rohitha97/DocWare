...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?php echo base_url('assets/bower_components/chartist/dist/chartist.min.css')?>" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo base_url('assets/bower_components/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.css')?>">
    <!-- Custom CSS -->
...
<body>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    <a class="navbar-brand" href="">
                        <span class="logo-text" style="color:black;font-family: 'Times New Roman', Times, serif;">
                            <h1>DocWare</h1>
                        </span>
                    </a>
                    <!-- ============================================================== -->
    ...
    <script src="<?php echo base_url('assets/bower_components/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js')?>"></script>
